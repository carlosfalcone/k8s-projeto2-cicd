...
powershell -Command "(Get-Content .github/workflows/cicd.yml) -replace '%%TAG_BACKFRONT%%', '%TAG_BACKFRONT%' -replace '%%TAG_DATABASE%%', '%TAG_DATABASE%' | Set-Content .github\workflows\cicd.yml"
